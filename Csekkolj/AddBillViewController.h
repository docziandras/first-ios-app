...
@interface AddBillViewController : UITableViewController <UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate>

@property (nonatomic, strong) NSNumber *amount;
@property (nonatomic, strong) NSDate *dueDate;
@property (nonatomic, strong) NSString *firstNotification;
@property (nonatomic, strong) NSString *secondNotification;
